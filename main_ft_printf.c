...
int	main(void)
{
	...
	// ft_printf("\n=> cnt : %d\t[CASE s-10]\n\n", ft_printf("%.2147483647s", long_str));
	// ft_printf("\n=> cnt : %d\t[CASE s-10]\n\n", ft_printf("%.2147483647d", 123));
	// ft_printf("\n=> cnt : %d\t[CASE s-10]\n\n", ft_printf("%.2147483648s", long_str));
	// ft_printf("\n=> cnt : %d\t[CASE s-10]\n\n", ft_printf("%.2147483648d", 123));
	// ft_printf("\n=> cnt : %d\t[CASE s-10]\n\n", ft_printf("Abc%1000000000dabc %1000000000ddabc %1000000000d%.", 123, 456, 789)); ft_printf("|ABC%1000000000dabc %1000000000ddabc %1000000000d%.", 123, 456, 789); // ft_printf("\n=> cnt : %d\t[CASE s-10]\n\n", ft_printf("%2147483646d %s", 123, long_str));
	// ft_printf("abc\n%1000000000d\nabc\n %1000000000dd\nabc\n %1000000000d\n", 123, 456, 789);
    //
    //
	// for (int i = 0; i < 3; i++)
